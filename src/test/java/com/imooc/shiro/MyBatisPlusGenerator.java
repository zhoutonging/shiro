...
public class MyBatisPlusGenerator {
	...
	public static void main(String[] args) throws SQLException {
		...
		dsConfig.setDbType(DbType.MYSQL) // 设置数据库类型
				.setDriverName("com.mysql.cj.jdbc.Driver").setUrl("jdbc:mysql://127.0.0.1:3306/shiro1?serverTimezone=CTT&autoReconnect=true&useSSL=false").setUsername("root")
				.setPassword("123456");
		...
		stConfig.setCapitalMode(true) // 全局大写命名
				...
				.setInclude("user_role"); // 生成的表.为空的话默认生成所有

		// 4. 包名策略配置
		PackageConfig pkConfig = new PackageConfig();
		pkConfig.setParent("com.imooc.shiro").setMapper("mapper")// dao
